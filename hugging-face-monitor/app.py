...
dataset_api.download("Resources/images/actual_result.png")
...
with gr.Blocks() as demo: 
    with gr.Row():
      with gr.Column(): 
          gr.Label("Today's Predicted Image of Passenger's Fate")
          input_img = gr.Image("latest_prediction.png", elem_id="predicted-img")
      with gr.Column():          
          gr.Label("Today's Actual Passenger's Fate")
          input_img = gr.Image("actual_result.png", elem_id="actual-img")
    with gr.Row():
      with gr.Column():
